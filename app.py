                ...
                dcc.Tab(label="Alpha Signal Analysis", value="alpha-tab", children=[
                    html.Div(style={"padding": "24px 0"}, children=[
                        ...
                        html.Div(style={"backgroundColor": "#172554", "border": "1px solid #1e40af", "padding": "14px 16px", "borderRadius": "6px", "marginBottom": "16px"}, children=[
                            ...
                            html.P("Each feature is calculated from trailing calendar-day distinct paper counts (breadth): a 20-day exponentially weighted average and a 30-day rolling sum. The first 52 weeks plus a horizon-specific embargo are withheld; displayed observations are held-out only.", style={"margin": "6px 0", "fontSize": "13px"}),
